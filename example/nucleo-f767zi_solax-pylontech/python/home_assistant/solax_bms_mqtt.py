  ...
  try:
    ...
    class Field(enum.Enum):
      def __new__(cls, *args, **kwds):
          ...
          return obj
      def __repr__(self):
          return str(self._value_) + ":" + str(self._format_)
    ...
    try:
      ...
      mqtt_client.publish('homeassistant/switch/solax_force_offgrid/state', payload=mqtt_boolstr(fields[Field.IDX_GRID_SWITCH_AUTO.value]==0), retain=True)
      mqtt_client.publish('homeassistant/switch/solax_force_grid_tie/state', payload=mqtt_boolstr(fields[Field.IDX_GRID_SWITCH_AUTO.value]==2), retain=True)
      mqtt_client.publish('homeassistant/switch/solax_auto_grid/state', payload=mqtt_boolstr(fields[Field.IDX_GRID_SWITCH_AUTO.value]==1), retain=True)
      ...
      mqtt_client.publish('homeassistant/switch/solax_force_stop_discharge/state', payload=mqtt_boolstr(fields[Field.IDX_SELF_USE_AUTO.value]==0), retain=True)
      mqtt_client.publish('homeassistant/switch/solax_force_charge/state', payload=mqtt_boolstr(fields[Field.IDX_SELF_USE_AUTO.value]==3), retain=True)
      mqtt_client.publish('homeassistant/switch/solax_force_self_use/state', payload=mqtt_boolstr(fields[Field.IDX_SELF_USE_AUTO.value]==2), retain=True)
      mqtt_client.publish('homeassistant/switch/solax_auto_mode/state', payload=mqtt_boolstr(fields[Field.IDX_SELF_USE_AUTO.value]==1), retain=True)
