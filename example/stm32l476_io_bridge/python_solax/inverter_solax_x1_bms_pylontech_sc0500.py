...
if __name__ == '__main__':
	...
	parser.add_argument("--baudrateinv", default="921600", help="IOBridge USART speed", type=auto_int)
	parser.add_argument("--portbms", default="/dev/ttyACM1", help="""IO bridge interface to the BMS""")
	parser.add_argument("--baudratebms", default="921600", help="IOBridge USART speed", type=auto_int)
